...
class KakaoRestApiHelperTest {
    ...
    @Test
    public void charge_info() throws IOException {

        StringBuilder urlBuilder = new StringBuilder("http://apis.data.go.kr/B552584/EvCharger/getChargerStatus"); /*URL*/
        urlBuilder.append("?" + URLEncoder.encode("serviceKey", "UTF-8") + "=U9kC%2FAGpetSp%2B6dcswjLqZluRmSBXvTRCFZHe4427d%2FffEBuxdCf8OG%2By%2F65k5fnDrUixiXm%2Bg%2FzAAL2SQfR8w%3D%3D"); /*Service Key*/
