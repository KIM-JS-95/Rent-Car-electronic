          ...
          <div class="container">
            ...
            <form action="/contents/list" class='form-inline'>
              <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Enter 검색어" id="word" name="word" value="${word}">
                      ...
                      <tr>
                        ...
                        <td>
                          <span style="color:#FF0040;">
                            &emsp;${dto.recommend}</span> <img src="/images/SJ/free-icon-love-1029132.png" style="height:25px; ">
                        </td>
                      </tr>
                    </c:forEach>
                  </c:otherwise>
